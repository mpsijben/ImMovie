...
public class FavoriteMovieDelete extends AsyncTask<Movie, Void, Void> {
    ...
    protected Void doInBackground(Movie... movies) {
        ...
        String reviewwhere = ContentProvider.MOVIEID + "=?";
        String[] reviewargs = new String[] { Integer.toString(movie.id) };
        contentResolver.delete(ReviewUri, reviewwhere,  reviewargs);
